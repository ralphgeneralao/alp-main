  ...
  return (
    <div className="main-error-page">
      ...
      >
        ...
        <g fill="none" fillRule="evenodd">
          ...
          <g>
            ...
            <g className="raios" stroke="#fdba55" strokeLinecap="round" strokeWidth="1.8">
              <path
      ...
      <h2 className="error-subtitle">
        Server might be down or your internet connection is unstable. <br />
        Try to refresh the page. If the problem persist, please contact administrator.
      </h2>
    </div>
  );
}
